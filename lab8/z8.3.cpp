...
Dokonaj specjalizacji szablonu operatora dodawania dla przypadku, 
w którym jeden z argumentów jest typu double tak aby możliwe było 
następujące użycie funkcji integrate:
